...
export async function GET(request) {
  try {
    ...
    const query = `
      SELECT id_personal, nombre, cargo, ultimo_acceso, area, permisos_ft, permisos_certificados, permisos_maquinaria, permisos_dc3, permisos_informe, permisos_citas, permisos_ia, rol, activo, debe_cambiar_password 
      FROM Personal_Area 
      WHERE id_personal = ?
